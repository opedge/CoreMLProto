...
public struct CoreML_Specification_DictVectorizer: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".DictVectorizer"

  public var map: OneOf_Map? {
    get {return _storage._map}
    set {_uniqueStorage()._map = newValue}
  }

  //// String keys to indexes
  public var stringToIndex: CoreML_Specification_StringVector {
    get {
  ...
  //// Int keys to indexes
  public var int64ToIndex: CoreML_Specification_Int64Vector {
    get {
...
extension CoreML_Specification_DictVectorizer: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: CoreML_Specification_DictVectorizer) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
        if _storage._map != other_storage._map {return false}
        return true
      }

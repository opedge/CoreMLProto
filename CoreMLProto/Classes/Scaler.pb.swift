...
/// error is generated.
public struct CoreML_Specification_Scaler: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".Scaler"

  public var shiftValue: [Double] = []
...
extension CoreML_Specification_Scaler: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "shiftValue"),
    2: .same(proto: "scaleValue"),
  ]

  public func _protobuf_generated_isEqualTo(other: CoreML_Specification_Scaler) -> Bool {
    if self.shiftValue != other.shiftValue {return false}
    if self.scaleValue != other.scaleValue {return false}
